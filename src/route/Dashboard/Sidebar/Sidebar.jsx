  ...
  return (
    <div className="flex flex-col h-full p-4 relative ">
      ...
      <nav className="flex flex-col gap-2 text-gray-700 font-medium flex-1">
        <NavLink
          to="/dashboard"
          className="flex items-center gap-2 hover:bg-secondary p-2 hover:text-primary transition-all duration-300 "
        >
          <IoHomeOutline /> Home
        </NavLink>
        ...
        {role?.includes("seller") && (
          <>
            <NavLink
              to="/dashboard/seller/add-medicine"
              className="flex items-center gap-2 hover:bg-secondary p-2 hover:text-primary transition-all duration-300 "
            >
              <IoAddCircleOutline /> Add Medicine
            </NavLink>
            <NavLink
              to="seller/my-medicine"
              className="flex items-center gap-2 hover:bg-secondary p-2 hover:text-primary transition-all duration-300 "
            >
      ...
      <div className="flex items-center justify-between gap-2 text-left text-red-600 mt-8">
