        ...
        >
          {products.map((product) => (
            <SwiperSlide key={product.id}>
              <div className="product-card shadow-md rounded-xl p-4 bg-white xl:h-[430px] h-[480px] transition-all duration-500 relative group my-10 hover:shadow-primary/70">
